...
module.exports = (app) => {
    ...
    app.get('/doacao/em-aberto', auth.jwtVerify, auth.groupVerify(['A', 'R', 'P']), controller.buscarAbertas);
    app.get('/doacao/status/:status', auth.jwtVerify, auth.groupVerify(['A', 'R', 'P']), controller.buscarPorStatus); 
    app.get('/doacao/minhas-retiradas', auth.jwtVerify, auth.groupVerify(['A', 'R', 'P']), controller.minhasRetiradas);
    ...
    app.put('/doacao/selecionar/:id', auth.jwtVerify, auth.groupVerify(['A', 'R', 'P']), controller.selecionarParaRetirada);
